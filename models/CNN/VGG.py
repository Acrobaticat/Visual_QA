...
def pop(model):
    ...
    This code is thanks to @joelthchao
    https://github.com/fchollet/keras/issues/2371#issuecomment-211734276

    :param model: VGG model
    :return: VGG model without the top layer
    """
...
def load_model_legacy(model, weight_path):
    ...
    were trained with legacy keras.
    New keras does not support loading these weights

    :param model: VGG model
    :param weight_path: VGG model weight file (including path)
    :return: None
    """
...
def VGG_16(weights_path=None):
    """
    To generate VGG16 Model

    :param weights_path: VGG16 model weight file (including path)
    :return: VGG16 model without the top 2 layers
    """
    model = Sequential()
